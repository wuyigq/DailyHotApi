...
const styles = css`
  :-hono-global {
    ...
    .landing-feature .feature-label {
      font-size: 13px;
    }
    @media (max-width: 768px) {
      .landing-title { font-size: 26px; }
      .landing-subtitle { font-size: 15px; }
      .landing-features { gap: 20px; margin-top: 36px; }
    }
  }
`;
    ...
    <Layout title="今日热榜">
      ...
      <main class="landing-main">
        <img
          ...
          alt="logo"
        />
        <h1 class="landing-title">🔥 今日热榜</h1>
        <p class="landing-subtitle">聚合全网热门数据，实时更新</p>
        <div class="landing-buttons">
          <a href="/hot" class="landing-btn primary">
            <svg class="landing-btn-icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
              <path fill="currentColor" d="m12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/>
            </svg>
            查看热榜
          </a>
          <button onclick="window.open('https://github.com/TryNew5/DailyHotApi#readme')" class="landing-btn">
            <svg class="landing-btn-icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
        ...
        <div class="landing-features">
          ...
          <div class="landing-feature">
            <span class="feature-num">JSON</span>
            <span class="feature-label">API 格式</span>
          </div>
          <div class="landing-feature">
            <span class="feature-num">60min</span>
            <span class="feature-label">缓存刷新</span>
          </div>
        </div>
      </main>
    </Layout>
